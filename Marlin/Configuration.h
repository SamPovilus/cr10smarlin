...
#define CUSTOM_MACHINE_NAME "Sams printer A"
 ...
 */
 /* Titan aero says 837, but im having massive overfeed issues. I'm wondering if I have twice the number of digrees per step as expected */
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 600, 100, 10000 }
